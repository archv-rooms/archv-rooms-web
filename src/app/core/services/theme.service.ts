...
valentines: {
  ...
  vars: {
    '--color-bg':          '#0f0008',
    '--color-bg-panel':    '#1e0015',
    '--color-bg-card':     '#2e0022',
    '--color-primary':     '#ff4081',
    '--color-primary-dim': '#c2185b',
    '--color-secondary':   '#ff80ab',
    '--color-accent':      '#ff1744',
    '--color-text':        '#ffe0f0',
    '--color-text-muted':  '#d080a0',
    '--color-text-dim':    '#8a3050',
    '--color-border':      '#5a0030',
    '--color-border-glow': '#ff4081',
    '--color-glow':        '0 0 16px #ff4081',
    '--color-error':       '#ff003c',
  }
},
carnival: {
...
newyear: {
  ...
  vars: {
    '--color-bg':          '#03030f',
    '--color-bg-panel':    '#07071e',
    '--color-bg-card':     '#0d0d30',
    '--color-primary':     '#ffd700',
    '--color-primary-dim': '#b8960a',
    '--color-secondary':   '#e0e0ff',
    '--color-accent':      '#ff6d00',
    '--color-text':        '#fff8d6',
    '--color-text-muted':  '#c8b840',
    '--color-text-dim':    '#7a6e20',
    '--color-border':      '#2a2500',
    '--color-border-glow': '#ffd700',
    '--color-glow':        '0 0 20px #ffd700',
    '--color-error':       '#ff003c',
  }
 }
}
